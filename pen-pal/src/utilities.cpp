...
ExampleArgs ParseExampleArguments(int argc, char *argv[])
{
    ...
    options.add_options()
        ...
        ("c,coordinates", "file path to coordinates csv data", cxxopts::value<std::string>()->default_value("ANN/1.csv"))
        ("g,gain", "file path to gain values used", cxxopts::value<std::string>()->default_value("English_gains.txt"))
